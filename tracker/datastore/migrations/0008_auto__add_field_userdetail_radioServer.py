...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDetail.radioServer'
        db.add_column(u'datastore_userdetail', 'radioServer',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserDetail.radioServer'
        db.delete_column(u'datastore_userdetail', 'radioServer')
