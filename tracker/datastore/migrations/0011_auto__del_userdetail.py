...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'datastore_userdetail')


    def backwards(self, orm):
        # Adding model 'UserDetail'
        db.create_table(u'datastore_userdetail', (
            ('radioServer', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
        ...
        db.send_create_signal(u'datastore', ['UserDetail'])
